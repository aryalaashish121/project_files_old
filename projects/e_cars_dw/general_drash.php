...
<div class="main_box">
   ...
   <div><form action="e_action.php" method="post">
        <input type="submit" name="delete_cookie" value="Delete Browsing Data"/>
        </form>
    </div>
    ...
    <?php 
		...
		<div class="main">;
            ...
            <div class="car_image">
                <img src="images/cars/<?Php echo $car['image'] ?>" id="img"/>
            ...
            <div class="rating">
                <table class="table">
                    <tr><td>Rating:
                        ...
                        $aa=1;
                            while($aa<=$a){?>
                            <img src="images/icon/star.png" id="star"><?php
                                $aa++;
                            }
                                 ?></td>
                    <td>Price: $ <?php echo $car['price']; ?>.</td>
                    <td><img src="images/icon/like.jpg" style="width:30px;height: 25px; cursor: pointer"></td></tr>
                </table>
            </div>
    ...
    <div>
        <form action="e_action.php" method="post" onload="img">
        <input type="hidden" name="car" value="<?php echo $car['c_name']; ?>"/>
